...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	data := struct {
		...
		HolderName: req.ReceiptAccountName,
	...
	ChannelResp, ChnErr := gozzle.Post(channel.ProxyPayUrl).Header("Authorization", "api-key "+l.svcCtx.ApiKey).Timeout(20).Trace(span).JSON(data)

...
type ProxyPayCallBackRequest struct {
	MyIp    string           `form:"ip, optional"`
	Code    int64            `json:"code, optional"`
	Message string           `json:"message, optional"`
	Data    ProxyPayCallData `json:"data, optional"`
}

type ProxyPayCallData struct {
	...
	NotifTime    int64  `json:"notify_time, optional"`
	Status       string `json:"status, optional"`
...
type PayCallBackData struct {
	...
	Notif_time   int64  `json:"notify_time, optional"`
	Status       string `json:"status, optional"`
	Extra        string `json:"extra, optional"`
	Sign         string `json:"sign, optional"`
